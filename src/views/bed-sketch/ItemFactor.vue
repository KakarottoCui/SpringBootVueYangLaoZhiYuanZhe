<template>
  <div id="advanced-search-div">
    <a-form-model class="ant-advanced-search-form" ref="ruleForm" :model="queryParams" :rules="validateRules"
      ...
      <a-row :gutter="5">
        <a-col :span="12">
          <a-form-model-item has-feedback ref="activityName" label="活动名称" prop="activityName">
            <a-input placeholder="请输入活动名称" v-model="queryParams.activityName" @blur="
                         () => {
        ...
        <a-col :span="12">
          <a-form-model-item has-feedback ref="activityPlace" label="活动地点" prop="activityPlace">
            <a-input placeholder="请输入活动地点" v-model="queryParams.activityPlace" @blur="
                         () => {
