    ...
    <a-card :bordered="false" class="card-area">
        ...
        <div>
            <div class="operator" style="width: auto">
                <a-dropdown v-hasPermission="['templateService:export']">
                ...
                <a-button v-hasPermission="['templateService:batchDelete']" @click="batchDelete">删除</a-button>
                <a-button type="primary" @click="addItem" v-hasPermission="['templateService:add']">新增服务</a-button>
                <ImportExcel v-hasPermission="['templateService:importData']" ref="ImportExcel" :importUrl="importUrl"
            ...
            <a-table ref="TableInfo" :columns="dataColumns" :dataSource="dataSource" :pagination="pagination"
                ...
                <template slot="operation" slot-scope="text, record">
                    <a-icon style="font-size: 20px" v-hasPermission="['templateService:edit']" type="edit"
    ...
    export default {
        ...
        data() {
            return {
                ...
                pageUrl: 'api/v1/templateService/queryByPage', //分页查询链接
                exportUrl: 'api/v1/templateService/exportData', //导出链接
                acceptFile: 'application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
                importUrl: process.env.BASE_API + 'api/v1/templateService/importData', //文件时上传,
                itemData: { //行信息
                    data: {},
                ...
                this.$confirm({
                    ...
                    onOk() {
                        ...
                        for (let key of that.selectedRowKeys) {
                            mainIdList.push(that.dataSource[key].serviceTemplateId)
                        }
                        console.log("mainIdList", mainIdList);
                        that.$delete('api/v1/templateService/batchDeleteItem/' + mainIdList.join(',')).then(
                        () => {
